...
export const api = {
  ...
  applications:t=>request('/applications',{token:t}), createApplication:(b,t)=>request('/applications',{method:'POST',body:b,token:t}), submitApplication:(n,t)=>request(`/applications/${n}/submit`,{method:'POST',token:t}),
